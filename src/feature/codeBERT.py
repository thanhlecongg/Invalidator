...
bert_embedding = RobertaModel.from_pretrained('microsoft/codebert-base', output_hidden_states = True) # Whether the model returns all hidden-states
...
_CORRECT_DATA = _PROCESSED_DATA_DIR + "correct.pkl"
